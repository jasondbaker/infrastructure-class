...
* Weekly reading quizzes (5%)
  ...
  ** Quizzes are timed (20 minutes) and may only be taken once.
...
* Midterm (25%)
* Final (25%)
* Fall 2016 grade distribution: A=45%, B=35%, C=20%.
...
|3 | 2/13 | Infrastructure fundamentals +
Virtualization +
...
|8 | 3/27 | Distributed application architecture +
Web services +
REST/ JSON / YAML |
Assignment 6 +
Read _Practice of Cloud Systems Administration_ Chapters 4 & 5

|9 | 4/3 | Infrastructure as code +
CloudFormation +
 |
Assignment 7 +
Read _Infrastructure as Code_ Chapters 5 & 6

|10 | 4/10 | Configuration Management +
Ansible +
 |
Assignment 8 +
