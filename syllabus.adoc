...
{blank}
[underline]#Computers# +
A computer is an essential tool for this class since many of our assignments will involve hands-on learning. Additionally,
the exams may have online components. A personal laptop is strongly encouraged.
...
Distributed infrastructure design and operations +
 |
Read Practice of Cloud Systems Administration Chapter 1 & 2 +
...
AWS +
Autoscaling, Cloudwatch, SQS, SNS, SES |
Read Web Operations Chapter 2
...
Web services +
REST/ JSON / YAML |
Read Practice of Cloud Systems Administration Chapter 4
