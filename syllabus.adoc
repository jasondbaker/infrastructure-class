...
[.text-center]
*SYLLABUS Fall 2018 SEIS 665-01* +
Version 2018.08.08
...
|3 | 9/24 | Virtualization & Cloud Computing +
AWS +
IAM, EC2, S3 |
Assignment 2 +
...
|7 | 10/22 | Midterm Challenge|


|8 | 10/29 | Infrastructure as code +
CloudFormation +
 |
Assignment 6 +
...
|12 | 11/26 | Serverless Applications +
Lambda, API Gateway |
Assignment 10 +
Read _Infrastructure as Code_ Chapters 9 & 14 +
Watch Lecture 12 video recordings

|13 | 12/3 | Service Discovery +
