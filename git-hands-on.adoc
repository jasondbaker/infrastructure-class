...
image:images/git-hands-on-logo.png["200","200",float="right"]
...
image:images/git-hands-on-branching.png[]
...
image:images/git-hands-on-clone.png[]
...
image:images/git-hands-on-pull.png["500","500"]
...
image:images/git-hands-on-rebase.png[]
