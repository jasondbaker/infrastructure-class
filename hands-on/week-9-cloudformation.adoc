...
*ami-3ea13f29* AMI and be associated with the *webserver-sg* security group. 

You will also need to add an application load balancer called *website-lb* and a target group called *webservers*.
