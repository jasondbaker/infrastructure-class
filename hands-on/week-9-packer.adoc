...
Remember to terminate all the resources created in this project, including the CloudFormation stack created by the Packer template. If you manually launched an EC2 instance to test your new AMI, you will need to terminate this test instance before deleting the stack.
