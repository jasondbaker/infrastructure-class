...
You will need to add two webservers with logical names of *Web1* and *Web2* to this template. The webservers should use the *ami-034b1e5cba4ade574* AMI and be associated with the *WebserverSG* security group. These websevers should also reference the *ClassInstanceProfile* instance profile to enable AWS Session Manager access.
