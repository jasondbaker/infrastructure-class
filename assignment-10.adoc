...
= DevOps & Cloud Infrastructure: Assignment 10
...
Create a new GitHub repository called `infrastructure-assignment10` and commit this screenshot file into the repository.
