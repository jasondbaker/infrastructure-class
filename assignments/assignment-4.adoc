...
Thefirst step is to make sure the ssh-agent is running on your workstation. This is a small helper application which caches your ssh credentials for the ssh client in Git for Windows. Open up a Git bash shell and type in the command:
