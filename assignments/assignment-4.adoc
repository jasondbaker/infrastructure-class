...
Next add your EC2 private key to the Mac keychain, replacing `server-key.pem` with your key name:
...
The first step is to add your EC2 private key to the Mac keychain:
