...
When your classroom repository is setup, GitHub will automatically copy projects files into it from a template repository. You do not need to fork an existing repository for this project.
