...
the `Sign Up` button. You are welcome to use an existing personal GitHub account if have one.
...
on their own will have difficulty on the exams.
...
Once your AWS account is setup, make note of your AWS Account ID (found in your
  account profile). Then, apply for educational credit by filling out an
