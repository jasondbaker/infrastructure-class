...
Go to the RDS dashboard on AWS and launch a new MySQL database cluster. The
...
The MySQL cluster should have the following properties:
...
The MySQL database cluster will take several minutes to launch. Once the
