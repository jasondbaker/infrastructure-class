...
The next step in the assignment is to create a launch template and auto
scaling group. Select the `Launch Templates` menu item and click on the
...
new launch template:
  ...
  * Type: t2.micro
  * Launch template name: wordpress-launch-config
...
Associate your local repository with this new GitHub repo and push the local main branch from your repository up to GitHub. Verify that your
