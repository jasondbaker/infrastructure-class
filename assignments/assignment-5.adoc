...
Create a shell script called `metadata.sh` inside the assignment directory where you setup the git repository. The shell script should meet the following requirements:

* If the user runs the script with no arguments, the script will perform the following operations:
...
Once you have completed the shell script, add and commit all the files in the present working directory to the repository. Next, you will need to push your local
