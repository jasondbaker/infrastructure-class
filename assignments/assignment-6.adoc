...
Connect to the new instance using an ssh terminal program. Type in the following
...
Fourth, modify the following line to include your MySQL instance endpoint:
  ...
  define('DB_HOST', 'wordpressdb.cqgfjsasiodi.us-west-2.rds.amazonaws.com:3306');
