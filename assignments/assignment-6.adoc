...
e) Finally, the script should add the following two lines to the configuration file, using the DSN name of your load balancer instead of `(load balancer DNS name)`.
