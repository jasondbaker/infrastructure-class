...
after the stack is launched.
  ...
  * Create two EC2 instances named (tagged) *web1* and *web2* in the PublicSubnet.
  ...
  * Create a load balancer (classic v1) named *EngineeringLB*
...
system. Next launch your new stack, provide the proper input parameters, and watch AWS CloudFormation go through the
build process. It will take a few minutes for CloudFormation to build the stack
resources.
