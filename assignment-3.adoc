...
First, log into GitHub and create a new repository called `assignment-3-shell-scripting-<username>`
...
.Example:
----
$ git remote add origin https://github.com/seis665/assignment-3-shell-scripting-jasondbaker
----
